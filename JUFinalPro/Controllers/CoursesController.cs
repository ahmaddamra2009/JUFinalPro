...
namespace JUFinalPro.Controllers
{
    ...
    public class CoursesController : Controller
    {
     ...
     [Authorize(Roles ="admin")]
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CourseId,CoursesName,CoursesDescription,SDate,STime,Price,DisPerc,Hours,UrlVideo,Venu,CategoryId,IsActive,IsDeleted,TransactionDate")] Course course)
        {
